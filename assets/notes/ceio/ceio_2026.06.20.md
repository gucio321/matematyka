...
Potem wymieniamy wyższe poprawki dla pomiaru energii elektronu (?).
Chodzi o to , że elektron potrafi wyemitować foton, który potem sobie tworzy pare elektron,pozytron, anichiluje i robi dalej co miał robić,
albo tworzy takie pary kilka razy.
...
Oddziaływania słabe:
Wszystko odziałuje słabo (nawet Ty). Oddziaływanie przez ciężki bozon $W_\pm$. 
Przykłądem jest rozpad beta ($p \to N + e^- + \bar{\nu_e}$)
- 
